...
public class ProductoAjustado implements Producto
{
    ...
    public void addIngrediente(Ingrediente ingredienteAdd) {
    	agregados.add(ingredienteAdd);
    }
    ...
    public void removeIngrediente(Ingrediente ingredienteRemove) {
    	eliminados.remove(ingredienteRemove);
    }
